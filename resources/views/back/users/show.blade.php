            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img src="{{asset('assets/images/' .$users['image_path'])}}" class="rounded-circle img-fluid" style="width: 60px;"
                            alt="Avatar" {{-- alt="" style="height:40px; width:40px;" --}}>
                        <h5 class="my-3"> {{$users->first_name}}{{$users->last_name}}</h5>
                        <p class="text-muted mb-1">Full Stack Developer</p>
                        <p class="text-muted mb-4">{{$users->region}}</p>
